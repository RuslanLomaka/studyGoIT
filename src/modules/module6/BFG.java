...
public class BFG{
   ...
   public BFG(int ammo, int damage,String name){
    ...
    public BFG(int ammo, int damage){
      this(ammo,damage,"modules.module6.BFG");
    }

   public BFG(int ammo){
        this(ammo,50,"modules.module6.BFG");
   }

   public BFG(){
        this(1000,50,"modules.module6.BFG");
   }
   ...
   @Override
    ...
    public static void main(String[] args) {
        ...
        //modules.module6.BFG, ammo: 5000, damage: 200
        System.out.println(new BFG(5000, 200));

        //modules.module6.BFG, ammo: 2000, damage: 50
        System.out.println(new BFG(2000));

        //modules.module6.BFG, ammo: 1000, damage: 50
